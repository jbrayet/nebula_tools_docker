...
float get_upper_quartile(const std::vector<float>& data);
...
int calculateBreakpoints_general(double threshold, int length, std::vector<float> ratio, std::vector<int>& bpfinal, int normal_chrom_length, int breakPointType);
