...
public:
  ...
  unsigned long get_state(){return _state;}
  void print();
...
public:
  ...
  */
  ...
  /* copy the values of data directly inside the program*/
  void store_prob(unsigned long init, vector<vector<float > >& , vector<vector<float > >&);
